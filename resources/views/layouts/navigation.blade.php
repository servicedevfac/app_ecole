...
<head>
    ...
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="{{url('public/fonts/flaticon.css')}}"> 
    <!-- Full Calender CSS -->
    <link rel="stylesheet" href="{{url('public/css/fullcalendar.min.css')}}">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{url('public/css/animate.min.css')}}">
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{url('public/style.css')}}">
    <!-- Modernize js -->
    <script src="{{url('public/js/modernizr-3.6.0.min.js')}}"></script> 
</head>

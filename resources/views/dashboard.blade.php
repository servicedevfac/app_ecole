...
@section('content') 
            <!-- Sidebar Area End Here -->
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('dashboard') }}">Tableau de bord administrateur</a>
                        </li>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="{{ $students->count() }}">{{ $students->count() }}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="{{ $parents->count() }}">{{ $parents->count() }}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>

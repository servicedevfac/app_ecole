                                        ...
                                        <td>{{ $parent->telephone }}</td>   
                                         <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('admin.parent.show', $parent->id) }}"><i class="fas fa-eye text-blue"></i>Voir</a>
                                                    <a class="dropdown-item" href="{{ route('admin.parent.edit', $parent->id) }}"><i class="fas fa-edit text-green"></i>Modifier</a>
